...
(function() {
  ...
  _.invoke = function(list, methodName, args) {
  	return _.map(list,function(value) {
	  	return typeof methodName === 'string' ? value[methodName](args) : methodName.call(value,args);
  	});
  };
  ...
  _.every = function(collection, iterator) {
    ...
    return _.reduce(collection, function(trueSoFar, item) {
	    ...
	    return typeof iterator === 'function' ? iterator(item) == true : item == true;
    }, true);
  };
  ...
  _.extend = function(obj) {
  	_.each(arguments, function(value, key, object) {
	  if (key > 0) _.each(value, function(thisValue, thisKey, thisObject) {
  ...
  _.defaults = function(obj) {
  	_.each(arguments, function(value, key, object) {
	  if (key > 0) _.each(value, function(thisValue, thisKey, thisObject) {
	  	if (obj[thisKey] == null) obj[thisKey] = thisValue;	
	  });
  	});
  	return obj;
  };
